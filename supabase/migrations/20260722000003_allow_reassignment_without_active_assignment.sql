...
-- Temporarily allow reassignment without a prior active assignment. When there is
-- no prior assignment, retain the normal event, history, case-state, and audit
-- behavior while skipping only the nonexistent assignment close and its audit log.
