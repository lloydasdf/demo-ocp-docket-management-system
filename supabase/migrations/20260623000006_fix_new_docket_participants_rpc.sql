...
BEGIN
  ...
  IF COALESCE((p_payload->>'caseAlsoRaffled')::boolean,false) AND v_assignment_date <> v_date_received THEN RAISE EXCEPTION 'Same-day raffle assignment date % must equal dateReceived %', v_assignment_date, v_date_received; END IF;
