-- Persist new docket notes in public.notes and expose case notes on the case details read model.
-- Keep this migration in sync with lib/supabase/dev-clone/dev_schema.sql.
