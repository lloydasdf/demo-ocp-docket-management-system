...
-- Charge Filed is optional when editing a Court Filing.
...
BEGIN
  ...
  IF v_court_name IS NULL OR p_date_filed IS NULL THEN RAISE EXCEPTION 'Court and Date Filed are required'; END IF;
