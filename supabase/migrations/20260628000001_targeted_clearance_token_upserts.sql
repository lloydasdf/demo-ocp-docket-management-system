...
COMMENT ON FUNCTION public.create_new_docket_entry(jsonb) IS 'Creates a docket entry and supports multiple places of commission via placesOfCommission[] (legacy placeOfCommission still accepted).';
