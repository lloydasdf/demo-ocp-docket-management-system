...
// Sample persons - with enriched aliases and multiple addresses
const samplePersons = {
  maria_garcia: {
    id: 'person-1',
    firstName: 'Maria',
    lastName: 'Garcia',
    middleName: 'Luz',
    aliases: ['Maria L. Garcia', 'M. Luz Garcia', 'ML Garcia', 'Mary Garcia', 'Maria Garcia-Santos', 'Maria Luz Reyes'],
    ...
    addresses: [
      ...
      },
      {
        ...
        street: '456 High Street Tower',
        barangay: 'Makati Business District',
        municipality: 'Makati',
        province: 'Metro Manila',
        zipCode: '1200',
        isPrimary: false,
  ...
  carlos_santos: {
    ...
    lastName: 'Santos',
    middleName: 'Rene',
    aliases: ['CR Santos', 'Carlos R. Santos', 'Carlito Santos', 'Charles Santos', 'C.R. Santos', 'Carl Santos'],
  ...
  juan_cruz: {
    ...
    lastName: 'Cruz',
    middleName: 'Miguel',
    aliases: ['JM Cruz', 'Juan M. Cruz', 'Juaning', 'J. Miguel Cruz', 'Juan Miguel', 'Johnny Cruz'],
  ...
  rosa_fernandez: {
    ...
    lastName: 'Fernandez',
    middleName: 'Pilar',
    aliases: ['Rosa P. Fernandez', 'RP Fernandez', 'Rosita Fernandez', 'R. Pilar Fernandez', 'Rosa Pilar'],
  ...
  rodrigo_torres: {
    ...
    lastName: 'Torres',
    middleName: 'Antonio',
    aliases: ['Rod Torres', 'Rodrigo T.', 'Rudy Torres', 'R.A. Torres', 'Rodrigo A. Torres'],
  ...
  rene_santos: {
    ...
    aliases: ['R. Alejandro Santos', 'Rene A. Santos', 'René Santos', 'Rene Alejandro', 'R.A. Santos'],
    dateOfBirth: '1987-04-12',
    gender: 'Male' as const,
    contactNumber: '09101234567',
    email: 'rene.santos@email.com',
    addresses: [
      {
        id: 'addr-6',
        type: 'Residential' as const,
        street: '234 Laurel Ave',
        barangay: 'Barangay Greenhills',
...
const sampleCases: CaseDetails[] = [
  ...
  {
    id: 'case-1b',
    caseNumber: 'OCP-2025-011',
    dateOfIncident: '2025-02-01',
    ...
    statusHistory: [
      {
        ...
        date: '2025-02-01',
        status: 'Pending',
        remarks: 'Case received - related respondent',
        updatedBy: 'Officer Santos',
      },
    ],
...
export const dockets: Docket[] = [
  {
    ...
    cases: [sampleCases[0], sampleCases[1]],
    status: 'Filed',
    description: 'Multiple cases involving Carlos Rene Santos - drug and theft charges',
  },
  {
    id: 'docket-2',
