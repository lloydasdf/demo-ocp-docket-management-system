...
type Status = { environment: EnvironmentRow[]; connection: { status: string; rootName?: string; message?: string; stage?: string; code?: string; description?: string; suggestion?: string } };
