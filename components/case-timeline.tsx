              ...
              : isCourtStatusUpdate
                ...
                : isMotionResolved
                  ? await recordMotionResolvedEvent({
                    caseId,
                    caseMotionId: addForm.motionResolveMotionId ? Number(addForm.motionResolveMotionId) : null,
